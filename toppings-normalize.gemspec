...
Gem::Specification.new do |spec|
  ...
  spec.description = %q{this gem sports support for the normalize sass library for toppings}
  spec.summary     = %q{this gem sports support for the normalize sass library for toppings}
  #spec.homepage      = ""
  spec.license     = "MIT"
